                    ...
                    <div id="scrollable" className="fit-content scrollable">
                        <div className="df row" >
                            {props.plans && Object.keys(props.plans).length > 0 &&
                                <div className="centered_outer_container" style={{ margin:"5px auto" }}>
                                   
                                    <div className="df  flex-1 m-h-primary space-between">
...
export default PackagesInsideApp;