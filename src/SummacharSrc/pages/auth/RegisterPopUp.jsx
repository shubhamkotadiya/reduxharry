                ...
                <div className='inner_signin_container radius-primary' style={{ boxShadow: "none", zIndex: 11 }}>
                    ...
                    {signInData.step <= 2 && (
                        ...
                        OTP sent on +91 {signInData.phoneNo}
                                            ...
                                            />
                                            {signInData.step == 1 && (
                                                <div className='no-otp line-margin-small row df row resend-btn' style={{ justifyContent: "flex-end", fontWeight: "normal", alignItems: "center" }}>
                                                    Didn't Recieve It?&nbsp;
                                                    <button
