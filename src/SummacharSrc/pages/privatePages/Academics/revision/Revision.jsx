...
const Revision = (props) => {
    ...
    return (
        <>
            <div className="wrapper_container enter_animation news_container acad_info" ref={ref} id="acadInfo_container" style={{ height: "100%", padding: "0px", paddingTop: "20px" }} onScroll={() => { props.onScroll(ref) }}>
                                ...
                                <div className="chapters-list-grid column" style={{ display: "flex", gridGap: "0px" }}>
                                    {props.data && props.data.length > 0 ?
                                        props.data.map((data, index) => {
                                            return <RevisionComponent data={data} key={index} />
                                        })
                                        :
                                        <NoData />}
                                    {props.scrollLoading && (
