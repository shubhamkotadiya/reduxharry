...
const AcadInfoPopUp = (Props) => {
    ...
    if (windowSize.width >= 960) {
        return (
          ...
          ></div> */}
                    <div className="news_popUp_Box enter_animation df centered_outer_container">
                        <div className="news_PopUp_carousal_area df flex-1">
                            <Slider
                                ...
                                onClick={(answer, data, index) => {
                                    Props.submitQuiz(answer, data, index);
                                }}
                        ...
                        <div className="news_popUp_content df flex-1">
                            ...
                            <span
                                className="txt-medium df row txt-secondary description-text"
                                style={{
                                    textAlign: "left",
                                    color: "#b8b8b9",
                                }}
                            ...
                            <p
                                className="txt-medium df row description-text"
                                style={{
                                    textAlign: "left",
                                }}
                            >
                            ...
                            >
                                <div className="df space-between row-center row" style={{ marginBottom: 20 }}>
                                    <div className="df row-center  column-center">
                                        {data.has_bookmarked ? (
                                            <button
                                                className="functionality_btn df has_bookmark_btn center"
                                                onClick={() => {
                                                    Props.bookMark(false);
                                                }}
                                            >
                                                <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 14 18" fill={Props.bookMarked ? "#5C56D4" : "none"}>
                                                    <g>
                                                ...
                                                {/* {Props.bookMarkLoader ? (
                                                    <img src={smallLoader} className="fit-content" />
                                                ) : (
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="24" viewBox="0 0 14 18" fill={Props.bookMarked ? "#5C56D4" : "none"}>
                                                        <g>
                                                            <path d="M12 0H2C0.9 0 0 0.9 0 2V18L7 15L14 18V2C14 0.9 13.1 0 12 0ZM11 2H7H2V3C2 2.5 2.45 2 3 2H11C11.55 2 12 2.45 12 3V2H11.5H11Z" fill="#5C56D4" />
                                                        </g>
                                                    </svg>
                                    ...
                                    <>
                                        ...
                                        <div className="df row news_popUp_categories_row">
                                            {data.tag_names.map((tag, index) => {
                                                return (
                                                    <span key={index} className="news_popUp_category metadata-text">
                                                        {tag}
                                                    </span>
                                                );
                                            })}
        ...
        return (
            <div className="pop_up_container enter_animation row df row-center" style={{ flexDirection: "column", overflowY: "scroll" }}>
                <Header
                    onBackClick={() => {
                        Props.onBackClick();
                    }}
                ...
                <div className="news_popUp_Box  df" style={{ flexDirection: "column", animation: "none" }}>
                    <div className="news_PopUp_carousal_area row df flex-1">
                        <Slider
                            onRead={() => {
                                Props.onRead();
                            }}
                    ...
                    <div className="df space-between action_area  row-center row news_PopUp_carousal_area row df flex-1">
                        <div className="df flex-1 row-center">
                            {data.has_bookmarked ? (
                                <button
                                    className="functionality_btn df center has_bookmark_btn"
                                    onClick={() => {
                                        Props.bookMark(false);
                                    }}
                                >
                                ...
                                >
                                    <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 14 18" fill="#5C56D4">
                                        <path d="M12 0H2C0.9 0 0 0.9 0 2V18L7 15L14 18V2C14 0.9 13.1 0 12 0ZM12 15L7 12.82L2 15V3C2 2.45 2.45 2 3 2H11C11.55 2 12 2.45 12 3V15Z" fill="#5C56D4" />
                                    </svg>
                                </button>
                            )}
                        ...
                        {/* <div className="df">
                            <button
                                className="functionality_btn df center"
                                onClick={() => {
                                    setInnerPopUpVisiblity(true);
                                }}
                            >
                    ...
                    <div className="news_popUp_content df flex-1  news_PopUp_carousal_area" style={{ paddingTop: 0, paddingLeft: 10, paddingRight: 10 }}>
                        <div
                            className="df row heading-text"
                            style={{
                                textAlign: "left",
