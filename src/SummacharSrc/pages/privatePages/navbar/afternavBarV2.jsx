...
const NavBar = (Props) => {
    ...
    ///// PLEASE DONT REMOVE THIS COMMENTED PART
    ...
    //useEffect(() => {
    //    window.addEventListener("touchstart", (event) => { touchstartX = event.changedTouches[0].screenX });
    //    return () => {
    //        return window.removeEventListener("touchstart", (event) => { touchstartX = event.changedTouches[0].screenX });
    //    };
    //}, []);

    //useEffect(() => {
    //    window.addEventListener("touchend", (event) => { touchendX = event.changedTouches[0].screenX; handleGesture() });
    //    return () => {
    //        return window.removeEventListener("touchend", (event) => { touchendX = event.changedTouches[0].screenX; });
    //    };
    //}, []);

    //function handleGesture() {
    //    if (touchendX < touchstartX && windowSize.width < 600) { setNameVisiblity(false)}
    //    if (touchendX > touchstartX && windowSize.width < 600) { setNameVisiblity(true) }
    //}
    ...
    // Used to determine header text in the navbar for movile;
    var headerTitle;
    if (history.location.pathname.split("/")[1] == "news") {
        headerTitle = history.location.pathname.split("/")[1];
    }
    else if (history.location.pathname.split("/").length > 2) {
        ...
        <>
                ...
                >
                    <div className="df row-center">
                        <div className="df logo_area  big_logo_area row-center">
                            {windowSize.width >= 1280 && windowSize.width < 1920 &&
                                <button
                                    className="bar_icon"
                                    onClick={() => {
                        ...
                        <div className={"header_title df"}>
                            {windowSize.width >= 1280 && windowSize.width < 1920 && headerTitle != "home" && headerTitle != "academics" && headerTitle != "activities" && headerTitle != "bookmarks" && headerTitle != "profile" && headerTitle != "knowledge" && headerTitle != "news" &&
                                <button
                                    className="df center header_back"
                                    style={{
                                ...
                                >
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 18" fill="none"><path d="M14.6669 7.66669H4.54685L8.94685 3.28002C9.19793 3.02895 9.33898 2.68843 9.33898 2.33336C9.33898 1.97829 9.19793 1.63776 8.94685 1.38669C8.69578 1.13562 8.35526 0.994568 8.00019 0.994568C7.64512 0.994568 7.30459 1.13562 7.05352 1.38669L0.386854 8.05336C0.265467 8.18016 0.170313 8.32969 0.106854 8.49336C-0.0265034 8.81797 -0.0265034 9.18208 0.106854 9.50669C0.170313 9.67036 0.265467 9.81989 0.386854 9.94669L7.05352 16.6134C7.17747 16.7383 7.32494 16.8375 7.48742 16.9052C7.6499 16.9729 7.82417 17.0078 8.00019 17.0078C8.1762 17.0078 8.35048 16.9729 8.51296 16.9052C8.67544 16.8375 8.8229 16.7383 8.94685 16.6134C9.07183 16.4894 9.17102 16.3419 9.23871 16.1795C9.3064 16.017 9.34125 15.8427 9.34125 15.6667C9.34125 15.4907 9.3064 15.3164 9.23871 15.1539C9.17102 14.9914 9.07183 14.844 8.94685 14.72L4.54685 10.3334H14.6669C15.0205 10.3334 15.3596 10.1929 15.6097 9.94283C15.8597 9.69278 16.0002 9.35365 16.0002 9.00002C16.0002 8.6464 15.8597 8.30726 15.6097 8.05722C15.3596 7.80717 15.0205 7.66669 14.6669 7.66669Z" fill="#5c56d4"></path></svg>
                                </button>
                            }
                            {headerTitle == "home" ? "Dashboard" : headerTitle.charAt(0).toUpperCase() + headerTitle.slice(1)}
                        </div>
                    </div>
...

                    {
                        ...
                        (
                            <span
                                className="txt-white user_name "
                                style={{ color: "#5c56d4", textAlign: "start", display: "flex", flexGrow: 1, margin: "auto 0 auto auto" }}
                            >
                                {/*<svg width="120" height="16" viewBox="0 0 120 16" fill="none" xmlns="http://www.w3.org/2000/svg">*/}
                                {/*    <g clipPath="url(#clip0_495:494)">*/}
                                {/*        <g clipPath="url(#clip1_495:494)">*/}
                                {/*            <path d="M4.50773 0.586016C5.57902 0.554858 6.6435 0.766074 7.62172 1.2039C8.43038 1.58089 9.10686 2.19253 9.56314 2.95925C10.0227 3.7681 10.2533 4.68684 10.2302 5.61684C10.2284 6.23662 10.1362 6.85281 9.95634 7.44592C9.7782 8.05346 9.48237 8.62006 9.08568 9.1135C8.65786 9.63607 8.11141 10.0489 7.49183 10.3177C6.71406 10.6416 5.87653 10.7971 5.03434 10.7741H2.92792V15.4643H0V0.586016H4.50773ZM5.01327 7.90582C5.39775 7.91795 5.77948 7.83727 6.12617 7.6706C6.40327 7.53343 6.6439 7.33251 6.82831 7.08432C7.11929 6.67217 7.28397 6.18422 7.30225 5.68004C7.29579 5.47947 7.2723 5.27981 7.23204 5.08322C7.17599 4.81598 7.07636 4.55979 6.93714 4.32491C6.77392 4.05222 6.53974 3.82896 6.25957 3.67894C5.88232 3.48598 5.4611 3.3952 5.03785 3.41564H2.93143V7.90582H5.01327Z" fill="#5C56D4" />*/}
                                {/*            <path d="M9.66138 15.4646L16.3738 0H16.5353L23.2478 15.4646H19.8529L15.5664 4.58146L17.6728 3.12803L12.5542 15.4646H9.66138ZM14.2534 10.0897H18.719L19.7511 12.5472H13.3406L14.2534 10.0897Z" fill="#5C56D4" />*/}
                                {/*            <path d="M23.1882 0.585938H33.2148V3.41556H29.5953V15.4643H26.6814V3.41556H23.2058L23.1882 0.585938Z" fill="#5C56D4" />*/}
                                {/*            <path d="M48.56 0.585938V15.4643H45.6391V9.41885H38.9688V15.4643H36.0374V0.585938H38.9688V6.58923H45.6391V0.585938H48.56Z" fill="#5C56D4" />*/}
                                {/*            <path d="M60.3456 4.1847C59.7955 3.88152 59.2213 3.62436 58.6288 3.41586C58.0991 3.22541 57.5416 3.12341 56.9788 3.11394C56.4466 3.08599 55.9189 3.22466 55.4692 3.51065C55.289 3.64133 55.1446 3.81537 55.0495 4.01664C54.9544 4.21792 54.9116 4.43994 54.925 4.66215C54.9258 4.83902 54.963 5.01383 55.0343 5.17569C55.1055 5.33756 55.2094 5.48302 55.3393 5.60302C55.6523 5.9072 56.0142 6.15644 56.4101 6.34027C56.8539 6.56117 57.3099 6.75691 57.7757 6.92655C58.2143 7.09336 58.6422 7.28681 59.0571 7.50582C59.4775 7.72393 59.8631 8.00314 60.2016 8.33434C60.5517 8.68596 60.8264 9.10525 61.0091 9.5666C61.2264 10.1439 61.329 10.758 61.311 11.3746C61.3165 12.1178 61.1134 12.8476 60.7247 13.481C60.3087 14.152 59.7143 14.6941 59.008 15.0468C58.1352 15.4739 57.1705 15.6789 56.1994 15.6436C55.6194 15.6427 55.0409 15.5851 54.4722 15.4716C53.2696 15.2333 52.1301 14.7466 51.1265 14.0427L52.4219 11.7608C52.78 12.0222 53.162 12.249 53.5629 12.4383C53.9617 12.6288 54.3778 12.7805 54.8057 12.8912C55.1811 12.9935 55.5681 13.0478 55.9572 13.0527C56.3135 13.0512 56.668 13.0004 57.0104 12.9018C57.3584 12.8118 57.6752 12.6285 57.9267 12.3716C58.1726 12.0942 58.2988 11.7307 58.2778 11.3606C58.2777 11.0651 58.1733 10.7791 57.9829 10.5531C57.761 10.2873 57.4949 10.0616 57.1965 9.88607C56.8536 9.67656 56.4915 9.50022 56.1152 9.35947C55.6553 9.18393 55.1848 8.98382 54.7109 8.75212C54.225 8.52567 53.7668 8.24413 53.3452 7.91306C52.9078 7.57957 52.5473 7.15567 52.2885 6.67027C52.0101 6.10932 51.8751 5.48816 51.8953 4.86226C51.8757 4.07559 52.0751 3.29894 52.4711 2.61893C52.8657 1.9797 53.4295 1.4621 54.1 1.12337C54.8513 0.739299 55.679 0.528181 56.5224 0.505489C57.5135 0.47293 58.5025 0.616765 59.4433 0.930283C60.1498 1.19033 60.8247 1.52952 61.4549 1.94136L60.3456 4.1847Z" fill="#5C56D4" />*/}
                                {/*            <path d="M76.7017 0.585938V15.4643H73.7702V9.41885H67.1175V15.4643H64.186V0.585938H67.1175V6.58923H73.7702V0.585938H76.7017Z" fill="#5C56D4" />*/}
                                {/*            <path d="M78.8643 15.4646L85.5767 0H85.7382L92.4471 15.4646H89.0523L84.7657 4.58146L86.8897 3.12803L81.7536 15.4646H78.8643ZM83.4527 10.0897H87.9218L88.9505 12.5472H82.5435L83.4527 10.0897Z" fill="#5C56D4" />*/}
                                {/*            <path d="M94.6133 0.585938H97.5447V12.6382H104.538V15.4678H94.6133V0.585938Z" fill="#5C56D4" />*/}
                                {/*            <path d="M105.893 15.4646L112.606 0H112.767L119.48 15.4646H116.081L111.795 4.58146L113.919 3.12803L108.783 15.4646H105.893ZM110.482 10.0897H114.951L115.98 12.5472H109.573L110.482 10.0897Z" fill="#5C56D4" />*/}
                                {/*        </g>*/}
                                {/*    </g>*/}
                                {/*    <defs>*/}
                                {/*        <clipPath id="clip0_495:494">*/}
                                {/*            <rect width="119.48" height="16" fill="white" />*/}
                                {/*        </clipPath>*/}
                                {/*        <clipPath id="clip1_495:494">*/}
            ...
            {windowSize.width >= 1280 && windowSize.width < 1920 &&
                <div className="df nav_container flex-1">
                    {location.pathname.slice(0, 9) != "/activity" && nameVisiblity && <nav
                        className={
                            nameVisiblity
                                ? "df vertical_nav_bar"
                                : "df vertical_nav_bar "
                                    ...
                                    <Link
                                        className={
                                            (location.pathname ==
                                                ...
                                                location.pathname ==
                                                "/profile/categories"
                                                ? "df row active row-center flex-1  margin20"
                    ...
                    <main
                        ...
                        style={{
                            ...
                            position:
                                (windowSize.width < 1280 || windowSize.width >= 1920) ? "fixed" : "unset",
