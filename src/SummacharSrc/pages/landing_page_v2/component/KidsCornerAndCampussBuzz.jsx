...
import perks_4 from '../../../assets/images/landing_page_new/playandwin/4.png';
import perks_5 from '../../../assets/images/landing_page_new/playandwin/5.png';
import { useHistory } from "react-router";
import Grid from '@mui/material/Grid';
import PlayAndWinCard from "../common/PlayAndWinCard";
import { Link } from "react-router-dom";
const KidsCornerAndCampussBuzz = () => {
    ...
    const dataList = [
       
        {
            ...
            img: perks_4,
            heading: "Kids’ Corner",
            description: "Dedicated Hall of Fame showcasing talents of all our budding artists, authors, poets and designers across India! Send us your creative submissions to get featured and win certificates and prizes!",
            type: "quiz"
        },
        {
            id: "3",
            img: perks_5,
            heading: "Campus Buzz",
            description: "Relive the memories of fun events from your school. See what other children across the country are up to in their schools. A place for schools to show off their events and achievements.",
            type: "competition"
        },
...
export default KidsCornerAndCampussBuzz