...
import learn_better_web from '../../../assets/images/landing_page_new/hero_image_desktop.png';
import learn_better_mobile from '../../../assets/images/landing_page_new/hero_image_mobile.png';
const HeroImageBox = () => {
    return (
        <>
